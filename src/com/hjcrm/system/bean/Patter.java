...
public class Patter {
    ...
    private Integer courseid;//  int(10) DEFAULT NULL COMMENT '课程id',
    private Integer patterTypeId;//  bigint(20) DEFAULT NULL COMMENT '话术场景类别',
    ...
    public Integer getPatterTypeId() {
        return patterTypeId;
    }

    public void setPatterTypeId(Integer patterTypeId) {
        this.patterTypeId = patterTypeId;
    }
