...
public class Menu {
    ...
    public Menu(int menuid, Integer menuparaid, String menuname, String menucode, int menuno, String menuurl, String menuimgurl, int dr, int menutype, Timestamp create_time, Timestamp update_time, int create_id, int update_id) {
        this.menuid = menuid;
