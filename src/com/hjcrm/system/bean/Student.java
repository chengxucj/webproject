...
public class Student {
    ...
    private String LCWoutTime;// timestamp NULL DEFAULT NULL COMMENT '理财网过期时间',
    ...
    public String getLCWoutTime() {
        return LCWoutTime;
    }

    public void setLCWoutTime(String LCWoutTime) {
        this.LCWoutTime = LCWoutTime;
    }
